# ova_formula.py — v3: arregla reg() para que use el ERA real de liga como
# respaldo (antes caía a un 4.10 fijo cuando el FIP no estaba disponible).
...
# ── ARREGLO v3: reg() ya no cae a un 4.10 fijo — usa el ERA real de liga ────
...
# ── ARREGLO v3: era_usado() ahora le pasa el ERA real de liga a reg() ───────
