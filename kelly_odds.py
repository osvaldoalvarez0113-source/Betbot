...
def panel_expertos(game_data: dict, sport: str) -> "dict | None":
    ...
    if _expert_lines:
        ...
        _synthesis_prompt = (
            ...
            "VOTOS RECIBIDOS:\n"
            + "\n".join(_expert_lines) + "\n\n"
            "FORMATO OBLIGATORIO — exactamente 4 líneas, en este orden:\n"
            f"Línea 1 — EL PICK: nombre del equipo/mercado y las odds. Ejemplo: 'Yankees ML a 1.85.'{_agree_note}\n"
            "Línea 2 — STAKE Y LIBRO: monto sugerido y dónde apostar. Ejemplo: 'Stake $20 en FanDuel.'\n"
            "Línea 3 — POR QUÉ: una sola razón en español llano que justifique la apuesta. "
            "Usa el punto más relevante entre los tres expertos — sin repetir los tres. "
